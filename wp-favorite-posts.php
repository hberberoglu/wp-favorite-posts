...
function wpfp_init() {
    ...
    $wpfp_options['cookie_warning'] = "Your favorite posts are saved to your browser cookies. If you clear cookies your favorite posts will be deleted.";
    ...
    $wpfp_options['thumbnail_show'] = '1';
    $wpfp_options['thumbnail_default'] = '';
    $wpfp_options['thumbnail_alignment'] = '';
    $wpfp_options['thumbnail_width'] = '150';
    $wpfp_options['thumbnail_height'] = '150';
