...
class WPFavoritePostsAdminPageFramework_Property_network_admin_page extends WPFavoritePostsAdminPageFramework_Property_admin_page {
    ...
    protected function _getOptions() {
        return $this->addAndApplyFilter($this->getElement($GLOBALS, array('aWPFavoritePostsAdminPageFramework', 'aPageClasses', $this->sClassName)), 'options_' . $this->sClassName, $this->sOptionKey ? get_site_option($this->sOptionKey, array()) : array());
    }
