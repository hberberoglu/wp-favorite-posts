...
class WPFavoritePostsAdminPageFramework_PageLoadInfo_network_admin_page extends WPFavoritePostsAdminPageFramework_PageLoadInfo_Base {
    ...
    public static function instantiate($oProp, $oMsg) {
        ...
        self::$_oInstance = new WPFavoritePostsAdminPageFramework_PageLoadInfo_network_admin_page($oProp, $oMsg);
        return self::$_oInstance;
    }
