...
class WPFavoritePostsAdminPageFramework_View__PageMetaboxEnabler extends WPFavoritePostsAdminPageFramework_FrameworkUtility {
    public $oFactory;
    ...
    private function _isMetaBoxAdded() {
        $_aPageMetaBoxClasses = $this->getElementAsArray($GLOBALS, array('aWPFavoritePostsAdminPageFramework', 'aMetaBoxForPagesClasses'));
    ...
    public function _replyToAddMetaboxScript() {
        $_bLoaded = $this->getElement($GLOBALS, array('aWPFavoritePostsAdminPageFramework', 'bAddedMetaBoxScript'), false);
        if ($_bLoaded) {
            return;
        }
        $GLOBALS['aWPFavoritePostsAdminPageFramework']['bAddedMetaBoxScript'] = true;
        $_sScript = <<<JAVASCRIPTS
jQuery( document).ready( function(){ 
    postboxes.add_postbox_toggles( pagenow ); 
});
JAVASCRIPTS;
        echo '<script class="wp-favorite-posts-insert-metabox-script">' . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . '</script>';
    }
}
