...
class WPFavoritePostsAdminPageFramework_View__Resource extends WPFavoritePostsAdminPageFramework_FrameworkUtility {
    public $oFactory;
    ...
    private function _enqueueAsset_style($asPageStyle) {
        $_oFormatter = new WPFavoritePostsAdminPageFramework_Format_PageResource_Style($asPageStyle);
    ...
    private function _enqueueAsset_script($asPageScript) {
        $_oFormatter = new WPFavoritePostsAdminPageFramework_Format_PageResource_Script($asPageScript);
