...
class WPFavoritePostsAdminPageFramework_View__PageRenderer__PageHeadingTabs extends WPFavoritePostsAdminPageFramework_FrameworkUtility {
    public $oFactory;
    public $sPageSlug;
    public $sTag = 'h2';
    ...
    private function _getPageHeadingtabNavigationBar(array $aPages, $sTag, $sCurrentPageSlug) {
        $_oTabBar = new WPFavoritePostsAdminPageFramework_TabNavigationBar($aPages, $sCurrentPageSlug, $sTag, array(), array('format' => array($this, '_replyToFormatNavigationTabItem_PageHeadingTab'),));
        $_sTabBar = $_oTabBar->get();
        return $_sTabBar ? "<div class='wp-favorite-posts-page-heading-tab'>" . $_sTabBar . "</div>" : '';
    }
