...
class WPFavoritePostsAdminPageFramework_View__PageRenderer extends WPFavoritePostsAdminPageFramework_FrameworkUtility {
    public $oFactory;
    public $sPageSlug;
    public $sTabSlug;
    ...
    public function render() {
        ...
        <div class="<?php echo esc_attr($this->oFactory->oProp->sWrapperClassAttribute); ?>">
            ...
            <div class="wp-favorite-posts-container">    
                <?php
        ...
        $this->_printPageMetaBoxes(); ?>     
            ...
            </div><!-- .wp-favorite-posts-container -->
    ...
    private function _getContentTop() {
        $_oScreenIcon = new WPFavoritePostsAdminPageFramework_View__PageRenderer__ScreenIcon($this->oFactory, $this->sPageSlug, $this->sTabSlug);
        $_sContentTop = $_oScreenIcon->get();
        $_oPageHeadingTabs = new WPFavoritePostsAdminPageFramework_View__PageRenderer__PageHeadingTabs($this->oFactory, $this->sPageSlug);
        $_sContentTop.= $_oPageHeadingTabs->get();
        $_oInPageTabs = new WPFavoritePostsAdminPageFramework_View__PageRenderer__InPageTabs($this->oFactory, $this->sPageSlug);
    ...
    private function _printMainPageContent($sPageSlug, $sTabSlug) {
        ...
        echo "<div class='wp-favorite-posts-content'>";
        ...
        echo "</div><!-- .wp-favorite-posts-content -->";
    }
    ...
    private function _printPageMetaBoxes() {
        $_oPageMetaBoxRenderer = new WPFavoritePostsAdminPageFramework_View__PageMataBoxRenderer();
    ...
    private function _printFormOpeningTag($fEnableForm = true) {
        ...
        echo "<form " . $this->getAttributes(array('method' => 'post', 'enctype' => $this->oFactory->oProp->sFormEncType, 'id' => 'wp-favorite-posts-form', 'action' => wp_unslash(remove_query_arg('settings-updated', $this->oFactory->oProp->sTargetFormPage)),)) . " >" . PHP_EOL;
