...
class WPFavoritePostsAdminPageFramework_Property_admin_page extends WPFavoritePostsAdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'wp-favorite-posts') {
        ...
        $GLOBALS['aWPFavoritePostsAdminPageFramework']['aPageClasses'] = $this->getElementAsArray($GLOBALS, array('aWPFavoritePostsAdminPageFramework', 'aPageClasses'));
        $GLOBALS['aWPFavoritePostsAdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
