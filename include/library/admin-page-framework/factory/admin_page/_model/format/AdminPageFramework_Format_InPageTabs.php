...
class WPFavoritePostsAdminPageFramework_Format_InPageTabs extends WPFavoritePostsAdminPageFramework_Format_Base {
    ...
    public function get() {
        ...
        foreach (( array )$_aInPageTabs as $_sTabSlug => $_aInPageTab) {
            ...
            $_oFormatter = new WPFavoritePostsAdminPageFramework_Format_InPageTab($_aInPageTab, $this->sPageSlug, $this->oFactory);
