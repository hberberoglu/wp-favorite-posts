...
abstract class WPFavoritePostsAdminPageFramework_CustomSubmitFields extends WPFavoritePostsAdminPageFramework_FrameworkUtility {
    public $aPost = array();
    public $sInputID;
...
class WPFavoritePostsAdminPageFramework_ExportOptions extends WPFavoritePostsAdminPageFramework_CustomSubmitFields {
    public $sClassName;
    public $sFileName;
    public $sFormatType;
    public $bIsDataSet;
        ...
        switch (strtolower($sFormatType)) {
            case 'text':
                if (in_array(gettype($vData), array('array', 'object'))) {
                    echo WPFavoritePostsAdminPageFramework_Debug::get($vData, null, false);
                }
                echo $vData;
                return;
            case 'json':
