...
class WPFavoritePostsAdminPageFramework_Model_Menu__RegisterMenu extends WPFavoritePostsAdminPageFramework_FrameworkUtility {
    public $oFactory;
    ...
    public function _replyToRegisterSubMenuItems() {
        ...
        foreach ($_aPages as $_aSubMenuItem) {
            $_oFormatter = new WPFavoritePostsAdminPageFramework_Format_SubMenuItem($_aSubMenuItem, $this->oFactory, ++$_iParsedIndex);
