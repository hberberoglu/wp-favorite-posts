...
class WPFavoritePostsAdminPageFramework_Model__FormSubmission__Validator_Base extends WPFavoritePostsAdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
...
class WPFavoritePostsAdminPageFramework_Model__FormSubmission__Validator extends WPFavoritePostsAdminPageFramework_Model__FormSubmission__Validator_Base {
    public $oFactory;
    ...
    public function _replyToValiateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
        ...
        $_aClassNames = array('WPFavoritePostsAdminPageFramework_Model__FormSubmission__Validator__Link', 'WPFavoritePostsAdminPageFramework_Model__FormSubmission__Validator__Redirect', 'WPFavoritePostsAdminPageFramework_Model__FormSubmission__Validator__Import', 'WPFavoritePostsAdminPageFramework_Model__FormSubmission__Validator__Export', 'WPFavoritePostsAdminPageFramework_Model__FormSubmission__Validator__Reset', 'WPFavoritePostsAdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'WPFavoritePostsAdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'WPFavoritePostsAdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm',);
        ...
        try {
            ...
            $_oFormSubmissionFilter = new WPFavoritePostsAdminPageFramework_Model__FormSubmission__Validator__Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);
