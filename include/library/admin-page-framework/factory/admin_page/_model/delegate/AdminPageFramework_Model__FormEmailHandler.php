...
class WPFavoritePostsAdminPageFramework_Model__FormEmailHandler extends WPFavoritePostsAdminPageFramework_FrameworkUtility {
    public $oFactory;
    ...
    public function _replyToSendFormEmail() {
        ...
        $_oEmail = new WPFavoritePostsAdminPageFramework_FormEmail($_aFormEmail['email_options'], $_aFormEmail['input'], $_aFormEmail['section_id']);
        $_bSent = $_oEmail->send();
        exit;
    }
}
