...
abstract class WPFavoritePostsAdminPageFramework_Model__FormSubmission_Base extends WPFavoritePostsAdminPageFramework_FrameworkUtility {
...
class WPFavoritePostsAdminPageFramework_Model__FormSubmission extends WPFavoritePostsAdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
    public function __construct($oFactory, $aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
        $this->oFactory = $oFactory;
        $this->_handleFormData();
        new WPFavoritePostsAdminPageFramework_Model__FormRedirectHandler($oFactory);
    }
    public function _handleFormData() {
        ...
        new WPFavoritePostsAdminPageFramework_Model__FormSubmission__Validator($this->oFactory);
