...
abstract class WPFavoritePostsAdminPageFramework_Router extends WPFavoritePostsAdminPageFramework_Factory {
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'wp-favorite-posts') {
    ...
    public function _replyToLoadComponentsForAjax() {
        ...
        new WPFavoritePostsAdminPageFramework_Model_Menu__RegisterMenu($this, 'pseudo_admin_menu');
...
abstract class WPFavoritePostsAdminPageFramework_Model_Form extends WPFavoritePostsAdminPageFramework_Router {
    public $aFieldErrors;
    ...
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'wp-favorite-posts') {
        ...
        new WPFavoritePostsAdminPageFramework_Model__FormEmailHandler($this);
    ...
    public function _replyToHandleSubmittedFormData($aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
        new WPFavoritePostsAdminPageFramework_Model__FormSubmission($this, $aSavedData, $aArguments, $aSectionsets, $aFieldsets);
    }
...
abstract class WPFavoritePostsAdminPageFramework_View_Form extends WPFavoritePostsAdminPageFramework_Model_Form {
...
abstract class WPFavoritePostsAdminPageFramework_Controller_Form extends WPFavoritePostsAdminPageFramework_View_Form {
    ...
    public function getValue() {
        ...
        return WPFavoritePostsAdminPageFramework_WPUtility::getOption($this->oProp->sOptionKey, empty($_aParams) ? null : $_aDimensionalKeys, $_mDefault, $this->getSavedOptions() + $this->oForm->getDefaultFormValues());
    }
...
abstract class WPFavoritePostsAdminPageFramework_Model_Page extends WPFavoritePostsAdminPageFramework_Controller_Form {
    public function _replyToFinalizeInPageTabs() {
        ...
        foreach ($this->oProp->aPages as $_sPageSlug => $_aPage) {
            ...
            $_oFormatter = new WPFavoritePostsAdminPageFramework_Format_InPageTabs($this->oProp->aInPageTabs[$_sPageSlug], $_sPageSlug, $this);
...
abstract class WPFavoritePostsAdminPageFramework_View_Page extends WPFavoritePostsAdminPageFramework_Model_Page {
    public function _replyToEnablePageMetaBoxes() {
        new WPFavoritePostsAdminPageFramework_View__PageMetaboxEnabler($this);
    }
    public function _replyToEnqueuePageAssets() {
        new WPFavoritePostsAdminPageFramework_View__Resource($this);
    }
    ...
    protected function _renderPage($sPageSlug, $sTabSlug = null) {
        $_oPageRenderer = new WPFavoritePostsAdminPageFramework_View__PageRenderer($this, $sPageSlug, $sTabSlug);
        $_oPageRenderer->render();
    }
}
abstract class WPFavoritePostsAdminPageFramework_Controller_Page extends WPFavoritePostsAdminPageFramework_View_Page {
...
abstract class WPFavoritePostsAdminPageFramework_Model_Menu extends WPFavoritePostsAdminPageFramework_Controller_Page {
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'wp-favorite-posts') {
        parent::__construct($sOptionKey, $sCallerPath, $sCapability, $sTextDomain);
        new WPFavoritePostsAdminPageFramework_Model_Menu__RegisterMenu($this);
    }
}
abstract class WPFavoritePostsAdminPageFramework_View_Menu extends WPFavoritePostsAdminPageFramework_Model_Menu {
}
abstract class WPFavoritePostsAdminPageFramework_Controller_Menu extends WPFavoritePostsAdminPageFramework_View_Menu {
    ...
    public function addSubMenuLink(array $aSubMenuLink) {
        ...
        $_oFormatter = new WPFavoritePostsAdminPageFramework_Format_SubMenuLink($aSubMenuLink, $this, count($this->oProp->aPages) + 1);
    ...
    public function addSubMenuPage(array $aSubMenuPage) {
        ...
        $_oFormatter = new WPFavoritePostsAdminPageFramework_Format_SubMenuPage($aSubMenuPage, $this, count($this->oProp->aPages) + 1);
        $_aSubMenuPage = $_oFormatter->get();
        $this->oProp->aPages[$_aSubMenuPage['page_slug']] = $_aSubMenuPage;
    }
}
abstract class WPFavoritePostsAdminPageFramework_Model extends WPFavoritePostsAdminPageFramework_Controller_Menu {
}
abstract class WPFavoritePostsAdminPageFramework_View extends WPFavoritePostsAdminPageFramework_Model {
    public function content($sContent) {
        return $sContent;
    }
}
abstract class WPFavoritePostsAdminPageFramework_Controller extends WPFavoritePostsAdminPageFramework_View {
    ...
    public function setAdminNotice($sMessage, $sClassSelector = 'error', $sID = '') {
        ...
        new WPFavoritePostsAdminPageFramework_AdminNotice($this->oProp->aAdminNotices[$sID]['sMessage'], $this->oProp->aAdminNotices[$sID]['aAttributes'], array('should_show' => array($this, 'isInThePage'),));
    }
    ...
    static public function getOption($sOptionKey, $asKey = null, $vDefault = null) {
        return WPFavoritePostsAdminPageFramework_WPUtility::getOption($sOptionKey, $asKey, $vDefault);
    }
}
abstract class WPFavoritePostsAdminPageFramework extends WPFavoritePostsAdminPageFramework_Controller {
    protected $_sStructureType = 'admin_page';
    public function __construct($isOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'wp-favorite-posts') {
    ...
    private function _getCallerPath($sCallerPath) {
        ...
        $_sCalllerPath = in_array($GLOBALS['pagenow'], array('plugins.php',)) || isset($_GET['page']) ? WPFavoritePostsAdminPageFramework_Utility::getCallerScriptPath(__FILE__) : null;
