...
abstract class WPFavoritePostsAdminPageFramework_MetaBox_Router extends WPFavoritePostsAdminPageFramework_Factory {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'wp-favorite-posts') {
...
abstract class WPFavoritePostsAdminPageFramework_MetaBox_Model extends WPFavoritePostsAdminPageFramework_MetaBox_Router {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'wp-favorite-posts') {
    ...
    public function _replyToGetSavedFormData() {
        $_oMetaData = new WPFavoritePostsAdminPageFramework_MetaBox_Model___PostMeta($this->_getPostID(), $this->oForm->aFieldsets);
...
abstract class WPFavoritePostsAdminPageFramework_MetaBox_View extends WPFavoritePostsAdminPageFramework_MetaBox_Model {
...
abstract class WPFavoritePostsAdminPageFramework_MetaBox_Controller extends WPFavoritePostsAdminPageFramework_MetaBox_View {
...
abstract class WPFavoritePostsAdminPageFramework_MetaBox extends WPFavoritePostsAdminPageFramework_MetaBox_Controller {
