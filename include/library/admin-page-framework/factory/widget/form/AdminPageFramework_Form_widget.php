...
class WPFavoritePostsAdminPageFramework_Form_widget extends WPFavoritePostsAdminPageFramework_Form {
    public $sStructureType = 'widget';
    public function construct() {
        $this->_addDefaultResources();
    }
    private function _addDefaultResources() {
        $_oCSS = new WPFavoritePostsAdminPageFramework_Form_View___CSS_widget;
