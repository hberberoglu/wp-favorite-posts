...
class WPFavoritePostsAdminPageFramework_Property_widget extends WPFavoritePostsAdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'wp-favorite-posts', $sStructureType) {
