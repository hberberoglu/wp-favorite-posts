...
abstract class WPFavoritePostsAdminPageFramework_PostType_Router extends WPFavoritePostsAdminPageFramework_Factory {
...
abstract class WPFavoritePostsAdminPageFramework_PostType_Model extends WPFavoritePostsAdminPageFramework_PostType_Router {
    public function __construct($oProp) {
        parent::__construct($oProp);
        ...
        if ($this->oProp->bIsAdmin) {
            ...
            if ($this->oProp->sCallerPath) {
                new WPFavoritePostsAdminPageFramework_PostType_Model__FlushRewriteRules($this);
            }
        }
    }
    ...
    public function _replyToRegisterPostType() {
        ...
        new WPFavoritePostsAdminPageFramework_PostType_Model__SubMenuOrder($this);
    }
...
abstract class WPFavoritePostsAdminPageFramework_PostType_View extends WPFavoritePostsAdminPageFramework_PostType_Model {
    public function __construct($oProp) {
        parent::__construct($oProp);
        if ($this->oProp->bIsAdmin) {
    ...
    public function _replyToPrintStyle() {
        ...
        if (!empty($this->oProp->sStyle)) {
            echo "<style type='text/css' id='wp-favorite-posts-style-post-type'>" . $this->oProp->sStyle . "</style>";
        }
    }
...
abstract class WPFavoritePostsAdminPageFramework_PostType_Controller extends WPFavoritePostsAdminPageFramework_PostType_View {
...
abstract class WPFavoritePostsAdminPageFramework_PostType extends WPFavoritePostsAdminPageFramework_PostType_Controller {
    protected $_sStructureType = 'post_type';
    public function __construct($sPostType, $aArguments = array(), $sCallerPath = null, $sTextDomain = 'wp-favorite-posts') {
        if (empty($sPostType)) {
            return;
        }
        ...
        $this->oProp->sPostType = WPFavoritePostsAdminPageFramework_WPUtility::sanitizeSlug($sPostType);
        $this->oProp->aPostTypeArgs = $aArguments;
    ...
    private function _getCallerScriptPath($sCallerPath) {
        ...
        $_sPageNow = WPFavoritePostsAdminPageFramework_Utility::getElement($GLOBALS, 'pagenow');
        if (in_array($_sPageNow, array('edit.php', 'post.php', 'post-new.php', 'plugins.php', 'tags.php', 'edit-tags.php', 'term.php'))) {
            return WPFavoritePostsAdminPageFramework_Utility::getCallerScriptPath(__FILE__);
        }
        return null;
    }
}
