...
abstract class WPFavoritePostsAdminPageFramework_TaxonomyField_Router extends WPFavoritePostsAdminPageFramework_Factory {
...
abstract class WPFavoritePostsAdminPageFramework_TaxonomyField_Model extends WPFavoritePostsAdminPageFramework_TaxonomyField_Router {
...
abstract class WPFavoritePostsAdminPageFramework_TaxonomyField_View extends WPFavoritePostsAdminPageFramework_TaxonomyField_Model {
...
abstract class WPFavoritePostsAdminPageFramework_TaxonomyField_Controller extends WPFavoritePostsAdminPageFramework_TaxonomyField_View {
    public function setUp() {
    }
}
abstract class WPFavoritePostsAdminPageFramework_TaxonomyField extends WPFavoritePostsAdminPageFramework_TaxonomyField_Controller {
    protected $_sStructureType = 'taxonomy_field';
    function __construct($asTaxonomySlug, $sOptionKey = '', $sCapability = 'manage_options', $sTextDomain = 'wp-favorite-posts') {
