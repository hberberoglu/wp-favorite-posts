...
abstract class WPFavoritePostsAdminPageFramework_UserMeta_Router extends WPFavoritePostsAdminPageFramework_Factory {
...
abstract class WPFavoritePostsAdminPageFramework_UserMeta_Model extends WPFavoritePostsAdminPageFramework_UserMeta_Router {
    public function _replyToGetSavedFormData() {
        $_iUserID = isset($GLOBALS['profileuser']->ID) ? $GLOBALS['profileuser']->ID : 0;
        $_oMetaData = new WPFavoritePostsAdminPageFramework_UserMeta_Model___UserMeta($_iUserID, $this->oForm->aFieldsets);
...
abstract class WPFavoritePostsAdminPageFramework_UserMeta_View extends WPFavoritePostsAdminPageFramework_UserMeta_Model {
...
abstract class WPFavoritePostsAdminPageFramework_UserMeta_Controller extends WPFavoritePostsAdminPageFramework_UserMeta_View {
...
abstract class WPFavoritePostsAdminPageFramework_UserMeta extends WPFavoritePostsAdminPageFramework_UserMeta_Controller {
    protected $_sStructureType = 'user_meta';
    public function __construct($sCapability = 'read', $sTextDomain = 'wp-favorite-posts') {
