...
class WPFavoritePostsAdminPageFramework_FrameworkUtility extends WPFavoritePostsAdminPageFramework_WPUtility {
    ...
    static public function getFrameworkVersion($bTrimDevVer = false) {
        $_sVersion = WPFavoritePostsAdminPageFramework_Registry::getVersion();
        return $bTrimDevVer ? self::getSuffixRemoved($_sVersion, '.dev') : $_sVersion;
    }
    static public function getFrameworkName() {
        return WPFavoritePostsAdminPageFramework_Registry::NAME;
    }
    static public function getFrameworkNameVersion() {
        return self::getFrameworkName() . ' ' . self::getFrameworkVersion();
    }
}
class WPFavoritePostsAdminPageFramework_ArrayHandler extends WPFavoritePostsAdminPageFramework_FrameworkUtility {
    public $aData = array();
