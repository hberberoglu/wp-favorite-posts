...
abstract class WPFavoritePostsAdminPageFramework_Utility_Deprecated {
    static public function minifyCSS($sCSSRules) {
        WPFavoritePostsAdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getCSSMinified()');
        return WPFavoritePostsAdminPageFramework_Utility_String::getCSSMinified($sCSSRules);
    }
    static public function sanitizeLength($sLength, $sUnit = 'px') {
        WPFavoritePostsAdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getLengthSanitized()');
        return WPFavoritePostsAdminPageFramework_Utility_String::getLengthSanitized($sLength, $sUnit);
    }
    public static function getCorrespondingArrayValue($vSubject, $sKey, $sDefault = '', $bBlankToDefault = false) {
        WPFavoritePostsAdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getElement()');
        if (!isset($vSubject)) {
            return $sDefault;
        }
    ...
    static public function isAssociativeArray(array $aArray) {
        WPFavoritePostsAdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__);
    ...
    static public function getAttributes(array $aAttributes) {
        WPFavoritePostsAdminPageFramework_Utility::showDeprecationNotice(__METHOD__, 'WPFavoritePostsAdminPageFramework_WPUtility::getAttributes()');
        $_sQuoteCharactor = "'";
        $_aOutput = array();
...
abstract class WPFavoritePostsAdminPageFramework_Utility_VariableType extends WPFavoritePostsAdminPageFramework_Utility_Deprecated {
...
abstract class WPFavoritePostsAdminPageFramework_Utility_String extends WPFavoritePostsAdminPageFramework_Utility_VariableType {
...
abstract class WPFavoritePostsAdminPageFramework_Utility_Array extends WPFavoritePostsAdminPageFramework_Utility_String {
...
abstract class WPFavoritePostsAdminPageFramework_Utility_ArrayGetter extends WPFavoritePostsAdminPageFramework_Utility_Array {
...
abstract class WPFavoritePostsAdminPageFramework_Utility_ArraySetter extends WPFavoritePostsAdminPageFramework_Utility_ArrayGetter {
...
abstract class WPFavoritePostsAdminPageFramework_Utility_Path extends WPFavoritePostsAdminPageFramework_Utility_ArraySetter {
...
abstract class WPFavoritePostsAdminPageFramework_Utility_URL extends WPFavoritePostsAdminPageFramework_Utility_Path {
...
abstract class WPFavoritePostsAdminPageFramework_Utility_File extends WPFavoritePostsAdminPageFramework_Utility_URL {
...
abstract class WPFavoritePostsAdminPageFramework_Utility_SystemInformation extends WPFavoritePostsAdminPageFramework_Utility_File {
...
abstract class WPFavoritePostsAdminPageFramework_Utility_HTMLAttribute extends WPFavoritePostsAdminPageFramework_Utility_SystemInformation {
...
class WPFavoritePostsAdminPageFramework_Utility extends WPFavoritePostsAdminPageFramework_Utility_HTMLAttribute {
