...
class WPFavoritePostsAdminPageFramework_WPUtility_URL extends WPFavoritePostsAdminPageFramework_Utility {
    ...
    static public function getQueryAdminURL($aAddingQueries = array(), $aRemovingQueryKeys = array(), $sSubjectURL = '') {
        $_sAdminURL = is_network_admin() ? network_admin_url(WPFavoritePostsAdminPageFramework_WPUtility_Page::getPageNow()) : admin_url(WPFavoritePostsAdminPageFramework_WPUtility_Page::getPageNow());
    ...
    static public function getSRCFromPath($sFilePath) {
        ...
        $_sRelativePath = WPFavoritePostsAdminPageFramework_Utility::getRelativePath(ABSPATH, $sFilePath);
...
class WPFavoritePostsAdminPageFramework_WPUtility_HTML extends WPFavoritePostsAdminPageFramework_WPUtility_URL {
...
class WPFavoritePostsAdminPageFramework_WPUtility_Page extends WPFavoritePostsAdminPageFramework_WPUtility_HTML {
...
class WPFavoritePostsAdminPageFramework_WPUtility_Hook extends WPFavoritePostsAdminPageFramework_WPUtility_Page {
...
class WPFavoritePostsAdminPageFramework_WPUtility_File extends WPFavoritePostsAdminPageFramework_WPUtility_Hook {
...
class WPFavoritePostsAdminPageFramework_WPUtility_Option extends WPFavoritePostsAdminPageFramework_WPUtility_File {
...
class WPFavoritePostsAdminPageFramework_WPUtility_Meta extends WPFavoritePostsAdminPageFramework_WPUtility_Option {
...
class WPFavoritePostsAdminPageFramework_WPUtility_SiteInformation extends WPFavoritePostsAdminPageFramework_WPUtility_Meta {
...
class WPFavoritePostsAdminPageFramework_WPUtility_SystemInformation extends WPFavoritePostsAdminPageFramework_WPUtility_SiteInformation {
...
class WPFavoritePostsAdminPageFramework_WPUtility extends WPFavoritePostsAdminPageFramework_WPUtility_SystemInformation {
