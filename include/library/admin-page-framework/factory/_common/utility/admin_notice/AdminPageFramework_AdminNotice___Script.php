...
class WPFavoritePostsAdminPageFramework_AdminNotice___Script extends WPFavoritePostsAdminPageFramework_Factory___Script_Base {
...
( function( $ ) {
    jQuery( document ).ready( function() {         
        ...
        var _oAdminNotices = jQuery( '.wp-favorite-posts-settings-notice-message' );
        if ( _oAdminNotices.length ) {
            ...
            var _oContainer     = jQuery( _oAdminNotices )
                ...
                .wrap( "<div class='wp-favorite-posts-admin-notice-animation-container'></div>" );
