...
class WPFavoritePostsAdminPageFramework_AdminNotice extends WPFavoritePostsAdminPageFramework_FrameworkUtility {
    ...
    public function __construct($sNotice, array $aAttributes = array('class' => 'error'), array $aCallbacks = array()) {
        ...
        $this->aAttributes['class'] = $this->getClassAttribute($this->aAttributes['class'], 'wp-favorite-posts-settings-notice-message', 'wp-favorite-posts-settings-notice-container', 'notice', 'is-dismissible');
        $this->aCallbacks = $aCallbacks + $this->aCallbacks;
        new WPFavoritePostsAdminPageFramework_AdminNotice___Script;
        if (!$sNotice) {
            return;
        }
