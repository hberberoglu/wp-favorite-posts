...
class WPFavoritePostsAdminPageFramework_Debug_Base extends WPFavoritePostsAdminPageFramework_FrameworkUtility {
...
class WPFavoritePostsAdminPageFramework_Debug_Log extends WPFavoritePostsAdminPageFramework_Debug_Base {
...
class WPFavoritePostsAdminPageFramework_Debug extends WPFavoritePostsAdminPageFramework_Debug_Log {
    ...
    static public function dumpArray($asArray, $sFilePath = null) {
        self::showDeprecationNotice('WPFavoritePostsAdminPageFramework_Debug::' . __FUNCTION__, 'WPFavoritePostsAdminPageFramework_Debug::dump()');
        WPFavoritePostsAdminPageFramework_Debug::dump($asArray, $sFilePath);
    }
    static public function getArray($asArray, $sFilePath = null, $bEscape = true) {
        self::showDeprecationNotice('WPFavoritePostsAdminPageFramework_Debug::' . __FUNCTION__, 'WPFavoritePostsAdminPageFramework_Debug::get()');
        return WPFavoritePostsAdminPageFramework_Debug::get($asArray, $sFilePath, $bEscape);
    }
    static public function logArray($asArray, $sFilePath = null) {
        self::showDeprecationNotice('WPFavoritePostsAdminPageFramework_Debug::' . __FUNCTION__, 'WPFavoritePostsAdminPageFramework_Debug::log()');
        WPFavoritePostsAdminPageFramework_Debug::log($asArray, $sFilePath);
    }
    static public function getAsString($mValue) {
        self::showDeprecationNotice('WPFavoritePostsAdminPageFramework_Debug::' . __FUNCTION__);
