...
class WPFavoritePostsAdminPageFramework_Form_Model___SetFieldResources extends WPFavoritePostsAdminPageFramework_Form_Base {
    ...
    private function ___setCommon() {
        ...
        new WPFavoritePostsAdminPageFramework_Form_View___Script_RegisterCallback;
        $this->___setCommonFormInternalCSSRules();
    }
    private function ___setCommonFormInternalCSSRules() {
        $_aClassNames = array('WPFavoritePostsAdminPageFramework_Form_View___CSS_Form', 'WPFavoritePostsAdminPageFramework_Form_View___CSS_Field', 'WPFavoritePostsAdminPageFramework_Form_View___CSS_Section', 'WPFavoritePostsAdminPageFramework_Form_View___CSS_CollapsibleSection', 'WPFavoritePostsAdminPageFramework_Form_View___CSS_FieldError', 'WPFavoritePostsAdminPageFramework_Form_View___CSS_ToolTip',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
            $this->aResources['internal_styles'][] = $_oCSS->get();
        }
        $_aClassNamesForIE = array('WPFavoritePostsAdminPageFramework_Form_View___CSS_CollapsibleSectionIE',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
    ...
    private function ___setFieldResourcesByFieldTypeDefinition($aFieldset, $_sFieldtype, $_aFieldTypeDefinition) {
        ...
        new WPFavoritePostsAdminPageFramework_Form_Model___FieldTypeRegistration($_aFieldTypeDefinition, $this->aArguments['structure_type']);
        $_oFieldTypeResources = new WPFavoritePostsAdminPageFramework_Form_Model___FieldTypeResource($_aFieldTypeDefinition, $this->aResources);
