...
class WPFavoritePostsAdminPageFramework_Form_Model___Format_RepeatableSection extends WPFavoritePostsAdminPageFramework_FrameworkUtility {
    ...
    public function __construct() {
        ...
        $this->_oMsg = $_aParameters[1] ? $_aParameters[1] : WPFavoritePostsAdminPageFramework_Message::getInstance();
    }
    public function get() {
...
class WPFavoritePostsAdminPageFramework_Form_Model___Format_RepeatableField extends WPFavoritePostsAdminPageFramework_Form_Model___Format_RepeatableSection {
    protected function _getDefaultMessage() {
