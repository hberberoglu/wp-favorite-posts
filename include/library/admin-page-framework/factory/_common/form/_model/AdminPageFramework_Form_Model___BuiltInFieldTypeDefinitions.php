...
class WPFavoritePostsAdminPageFramework_Form_Model___BuiltInFieldTypeDefinitions {
    ...
    public function get() {
        ...
        foreach (self::$_aDefaultFieldTypeSlugs as $_sFieldTypeSlug) {
            $_sFieldTypeClassName = "WPFavoritePostsAdminPageFramework_FieldType_{$_sFieldTypeSlug}";
