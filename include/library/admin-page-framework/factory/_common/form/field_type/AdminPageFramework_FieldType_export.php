...
class WPFavoritePostsAdminPageFramework_FieldType_submit extends WPFavoritePostsAdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".wp-favorite-posts-field input[type='submit'] {margin-bottom: 0.5em;}";
    }
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] || '0' === ( string )$aField['label_min_width'] ? "min-width:" . $this->getLengthSanitized($aField['label_min_width']) . ";" : null, 'class' => 'wp-favorite-posts-input-label-container' . ' wp-favorite-posts-input-button-container' . ' wp-favorite-posts-input-container',);
    }
...
class WPFavoritePostsAdminPageFramework_FieldType_export extends WPFavoritePostsAdminPageFramework_FieldType_submit {
