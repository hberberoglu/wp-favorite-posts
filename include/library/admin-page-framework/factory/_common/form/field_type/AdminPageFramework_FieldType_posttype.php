...
class WPFavoritePostsAdminPageFramework_FieldType_checkbox extends WPFavoritePostsAdminPageFramework_FieldType {
...
jQuery( document ).ready( function(){
    ...
    jQuery( '{$_sClassSelectorSelectAll}' ).each( function(){
        jQuery( this ).before( '<div class=\"select_all_button_container\" onclick=\"jQuery( this ).selectAllWPFavoritePostsAdminPageFrameworkCheckboxes(); return false;\"><a class=\"select_all_button button button-small\">' + jQuery( this ).data( 'select_all_button' ) + '</a></div>' );
    });            
    jQuery( '{$_sClassSelectorSelectNone}' ).each( function(){
        jQuery( this ).before( '<div class=\"select_none_button_container\" onclick=\"jQuery( this ).deselectAllWPFavoritePostsAdminPageFrameworkCheckboxes(); return false;\"><a class=\"select_all_button button button-small\">' + jQuery( this ).data( 'select_none_button' ) + '</a></div>' );
    });
});
JAVASCRIPTS;
    ...
    private function _getSelectButtonClassSelectors(array $aFieldTypeSlugs, $sDataAttribute = 'select_all_button') {
        ...
        foreach ($aFieldTypeSlugs as $_sSlug) {
            ...
            $_aClassSelectors[] = '.wp-favorite-posts-checkbox-container-' . $_sSlug . "[data-{$sDataAttribute}]";
        }
        return implode(',', $_aClassSelectors);
    }
    protected function getStyles() {
        return ".select_all_button_container, .select_none_button_container{display: inline-block;margin-bottom: 0.4em;}.wp-favorite-posts-checkbox-label {margin-top: 0.1em;}.wp-favorite-posts-field input[type='checkbox' ] {margin-right: 0.5em;} .wp-favorite-posts-field-checkbox .wp-favorite-posts-input-label-container {padding-right: 1em;}.wp-favorite-posts-field-checkbox .wp-favorite-posts-input-label-string{display: inline; }";
    }
...
class WPFavoritePostsAdminPageFramework_FieldType_posttype extends WPFavoritePostsAdminPageFramework_FieldType_checkbox {
    ...
    protected function getStyles() {
        ...
        return $_sParentStyles . ".wp-favorite-posts-field input[type='checkbox'] {margin-right: 0.5em;} .wp-favorite-posts-field-posttype .wp-favorite-posts-input-label-container {padding-right: 1em;}";
    }
    protected function getField($aField) {
