...
abstract class WPFavoritePostsAdminPageFramework_FieldType_Base extends WPFavoritePostsAdminPageFramework_Form_Utility {
    ...
    public function __construct($asClassName = 'admin_page_framework', $asFieldTypeSlug = null, $oMsg = null, $bAutoRegister = true) {
        ...
        $this->oMsg = $oMsg ? $oMsg : WPFavoritePostsAdminPageFramework_Message::getInstance();
        if ($bAutoRegister) {
    ...
    protected function getFieldOutput(array $aFieldset) {
        ...
        $_oFieldset = new WPFavoritePostsAdminPageFramework_Form_View___Fieldset($aFieldset, $_oCallerForm->aSavedData, $_oCallerForm->getFieldErrors(), $_oCallerForm->aFieldTypeDefinitions, $_oCallerForm->oMsg, $_oCallerForm->aCallbacks);
    ...
    protected function enqueueMediaUploader() {
        ...
        if (function_exists('wp_enqueue_media')) {
            new WPFavoritePostsAdminPageFramework_Form_View___Script_MediaUploader($this->oMsg);
        } else {
...
abstract class WPFavoritePostsAdminPageFramework_FieldType extends WPFavoritePostsAdminPageFramework_FieldType_Base {
    public function _replyToFieldLoader() {
        $this->setUp();
    }
    public function _replyToGetScripts() {
...
class WPFavoritePostsAdminPageFramework_FieldType_color extends WPFavoritePostsAdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".repeatable .colorpicker {display: inline;}.wp-favorite-posts-field-color .wp-picker-container {vertical-align: middle;}.wp-favorite-posts-field-color .ui-widget-content {border: none;background: none;color: transparent;}.wp-favorite-posts-field-color .ui-slider-vertical {width: inherit;height: auto;margin-top: -11px;}.wp-favorite-posts-field-color .wp-favorite-posts-repeatable-field-buttons {margin-top: 0;}.wp-favorite-posts-field-color .wp-color-result {margin: 3px;}";
    }
    protected function getScripts() {
        $_aJSArray = json_encode($this->aFieldTypeSlugs);
        $_sDoubleQuote = '\"';
        return <<<JAVASCRIPTS
registerWPFavoritePostsAdminPageFrameworkColorPickerField = function( osTragetInput, aOptions ) {
    ...
    var _aDefaults = {
        ...
        change: function( event, ui ){
            jQuery( this ).trigger( 
                'wp-favorite-posts_field_type_color_changed',
        ...
        clear: function( event, ui ) {
            jQuery( this ).trigger(
                'wp-favorite-posts_field_type_color_cleared',
    ...
    jQuery().registerWPFavoritePostsAdminPageFrameworkCallbacks( {     
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            oCloned.find( 'input.input_color' ).each( function( iIterationIndex ) {
                ...
                registerWPFavoritePostsAdminPageFrameworkColorPickerField( _oNewColorInput );                
...
JAVASCRIPTS;
    ...
    protected function getField($aField) {
        ...
        return $aField['before_label'] . "<div class='wp-favorite-posts-input-label-container'>" . "<label for='{$aField['input_id']}'>" . $aField['before_input'] . ($aField['label'] && !$aField['repeatable'] ? "<span " . $this->getLabelContainerAttributes($aField, 'wp-favorite-posts-input-label-string') . ">" . $aField['label'] . "</span>" : "") . "<input " . $this->getAttributes($aField['attributes']) . " />" . $aField['after_input'] . "<div class='repeatable-field-buttons'></div>" . "</label>" . "<div class='colorpicker' id='color_{$aField['input_id']}'></div>" . $this->_getColorPickerEnablerScript("{$aField['input_id']}") . "</div>" . $aField['after_label'];
    }
...
jQuery( document ).ready( function(){
    registerWPFavoritePostsAdminPageFrameworkColorPickerField( '{$sInputID}' );
});            
JAVASCRIPTS;
