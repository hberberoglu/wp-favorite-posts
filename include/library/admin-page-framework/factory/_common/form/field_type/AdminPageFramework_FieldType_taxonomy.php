...
class WPFavoritePostsAdminPageFramework_FieldType_taxonomy extends WPFavoritePostsAdminPageFramework_FieldType_checkbox {
    ...
    protected function setUp() {
        new WPFavoritePostsAdminPageFramework_Form_View___Script_CheckboxSelector;
    }
    protected function getScripts() {
        $_aJSArray = json_encode($this->aFieldTypeSlugs);
        return parent::getScripts() . <<<JAVASCRIPTS
/* For tabs */
var enableWPFavoritePostsAdminPageFrameworkTabbedBox = function( nodeTabBoxContainer ) {
...
jQuery( document ).ready( function() {
    ...
    enableWPFavoritePostsAdminPageFrameworkTabbedBox( jQuery( '.tab-box-container' ) );
    ...
    jQuery().registerWPFavoritePostsAdminPageFrameworkCallbacks( {
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            // Initialize
            enableWPFavoritePostsAdminPageFrameworkTabbedBox( oCloned.find( '.tab-box-container' ) );
...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return ".wp-favorite-posts-field .taxonomy-checklist li { margin: 8px 0 8px 20px; }.wp-favorite-posts-field div.taxonomy-checklist {padding: 8px 0 8px 10px;margin-bottom: 20px;}.wp-favorite-posts-field .taxonomy-checklist ul {list-style-type: none;margin: 0;}.wp-favorite-posts-field .taxonomy-checklist ul ul {margin-left: 1em;}.wp-favorite-posts-field .taxonomy-checklist-label {white-space: nowrap; }.wp-favorite-posts-field .tab-box-container.categorydiv {max-height: none;}.wp-favorite-posts-field .tab-box-tab-text {display: inline-block;font-size: 13px;font-size: smaller;padding: 2px;}.wp-favorite-posts-field .tab-box-tabs {line-height: 12px;margin-bottom: 0;}.wp-favorite-posts-field .tab-box-tabs .tab-box-tab.active {display: inline;border-color: #dfdfdf #dfdfdf #fff;margin-bottom: 0px;padding-bottom: 4px;background-color: #fff;}.wp-favorite-posts-field .tab-box-container { position: relative; width: 100%; clear: both;margin-bottom: 1em;}.wp-favorite-posts-field .tab-box-tabs li a { color: #333; text-decoration: none; }.wp-favorite-posts-field .tab-box-contents-container {padding: 0 0 0 1.8em;padding: 0.55em 0.5em 0.55em 1.8em;border: 1px solid #dfdfdf; background-color: #fff;}.wp-favorite-posts-field .tab-box-contents { overflow: hidden; overflow-x: hidden; position: relative; top: -1px; height: 300px;}.wp-favorite-posts-field .tab-box-content { display: none; overflow: auto; display: block; position: relative; overflow-x: hidden;}.wp-favorite-posts-field .tab-box-content .taxonomychecklist {margin-right: 3.2em;}.wp-favorite-posts-field .tab-box-content:target, .wp-favorite-posts-field .tab-box-content:target, .wp-favorite-posts-field .tab-box-content:target { display: block; }.wp-favorite-posts-field .tab-box-content .select_all_button_container, .wp-favorite-posts-field .tab-box-content .select_none_button_container{display: inline-block;margin-top: 0.8em;}.wp-favorite-posts-field .taxonomychecklist .children {margin-top: 6px;margin-left: 1em;}";
    }
