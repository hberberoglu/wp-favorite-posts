...
class WPFavoritePostsAdminPageFramework_FieldType_textarea extends WPFavoritePostsAdminPageFramework_FieldType {
...
jQuery( document ).ready( function(){
    ...
    var updateFoundEditors = function( oElements ) {
        ...
        oElements.each( function( iIndex ) {
            ...
            var oSettings = jQuery().getWPFavoritePostsAdminPageFrameworkInputOptions( oWrap.attr( 'data-id' ) );   
    ...
    jQuery().registerWPFavoritePostsAdminPageFrameworkCallbacks( {	
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            var _oSettings = jQuery().getWPFavoritePostsAdminPageFrameworkInputOptions( _oWrap.attr( 'data-id' ) );  

            // Elements
            var _oField              = oCloned.closest( '.wp-favorite-posts-field' );
        ...
        stopped_sorting_fields : function( oSortedFields, sFieldType, sFieldsTagID, iCallType ) { 
            ...
            // Update the editor.
            setTimeout(function(){
                var _oFields = oSortedFields.children( '.wp-favorite-posts-field' );
        ...
        stopped_sorting_sections: function( oSections ) {
            ...
            setTimeout(function(){
                var _oFields = jQuery( oSections ).find( '.wp-favorite-posts-field' );
                updateFoundEditors( _oFields );           
            }, 100 );
        ...
        saved_widget : function( oWidget ) { 
            ...
            jQuery( oWidget ).find( '.wp-favorite-posts-field' ).each( function( iIndex ) {
                ...
                // Store the settings.
                jQuery().storeWPFavoritePostsAdminPageFrameworkInputOptions( 
                    oWrap.attr( 'data-id' ), 
                    { 
...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return ".wp-favorite-posts-field-textarea .wp-favorite-posts-input-label-string {vertical-align: top;margin-top: 2px;} .wp-favorite-posts-field-textarea .wp-core-ui.wp-editor-wrap {margin-bottom: 0.5em;}.wp-favorite-posts-field-textarea.wp-favorite-posts-field .wp-favorite-posts-input-label-container {vertical-align: top; float: left;clear: both;} .postbox .wp-favorite-posts-field-textarea .wp-favorite-posts-input-label-container {width: 100%;}.wp-favorite-posts-field-textarea textarea {max-width: 100%;}";
    }
    ...
    private function _getFieldOutputByLabel($sKey, $sLabel, $aField) {
        ...
        $_sClassSelector = $_bIsArray ? 'wp-favorite-posts-field-textarea-multiple-labels' : '';
        ...
        $_aOutput = array($this->getElementByLabel($aField['before_label'], $sKey, $aField['label']), "<div class='wp-favorite-posts-input-label-container {$_sClassSelector}'>", "<label for='" . $aField['attributes']['id'] . "'>", $this->getElementByLabel($aField['before_input'], $sKey, $aField['label']), $_sLabel ? "<span " . $this->getLabelContainerAttributes($aField, 'wp-favorite-posts-input-label-string') . ">" . $_sLabel . "</span>" : '', $this->_getEditor($aField), $this->getElementByLabel($aField['after_input'], $sKey, $aField['label']), "</label>", "</div>", $this->getElementByLabel($aField['after_label'], $sKey, $aField['label']),);
        return implode('', $_aOutput);
    }
...
JAVASCRIPTS;
        return "<script type='text/javascript' class='wp-favorite-posts-textarea-enabler'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
}
