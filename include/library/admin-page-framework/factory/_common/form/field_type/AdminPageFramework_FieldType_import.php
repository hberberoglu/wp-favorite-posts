...
class WPFavoritePostsAdminPageFramework_FieldType_import extends WPFavoritePostsAdminPageFramework_FieldType_submit {
    ...
    protected function getStyles() {
        return ".wp-favorite-posts-field-import input {margin-right: 0.5em;}.wp-favorite-posts-field-import label,.form-table td fieldset.wp-favorite-posts-fieldset .wp-favorite-posts-field-import label { display: inline; }";
    }
