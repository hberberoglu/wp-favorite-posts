...
class WPFavoritePostsAdminPageFramework_FieldType_size extends WPFavoritePostsAdminPageFramework_FieldType_select {
    ...
    protected function getStyles() {
        return ".wp-favorite-posts-field-size input {text-align: right;}.wp-favorite-posts-field-size select.size-field-select {vertical-align: 0px; }.wp-favorite-posts-field-size label {width: auto; } .form-table td fieldset .wp-favorite-posts-field-size label {display: inline;}";
    }
    protected function getField($aField) {
