...
class WPFavoritePostsAdminPageFramework_FieldType_radio extends WPFavoritePostsAdminPageFramework_FieldType {
    public $aFieldTypeSlugs = array('radio');
    protected $aDefaultKeys = array('label' => array(), 'attributes' => array(),);
    protected function getStyles() {
        return ".wp-favorite-posts-field input[type='radio'] {margin-right: 0.5em;} .wp-favorite-posts-field-radio .wp-favorite-posts-input-label-container {padding-right: 1em;} .wp-favorite-posts-field-radio .wp-favorite-posts-input-container {display: inline;} .wp-favorite-posts-field-radio .wp-favorite-posts-input-label-string{display: inline; }";
    }
...
jQuery( document ).ready( function(){
    jQuery( 'input[type=radio][data-id=\"{$sInputID}\"]' ).change( function() {
        ...
        jQuery( this ).closest( '.wp-favorite-posts-field' ).find( 'input[type=radio][data-id=\"{$sInputID}\"]' ).attr( 'checked', false );
