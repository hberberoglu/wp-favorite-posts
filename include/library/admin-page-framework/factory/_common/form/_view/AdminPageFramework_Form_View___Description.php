...
class WPFavoritePostsAdminPageFramework_Form_View___Description extends WPFavoritePostsAdminPageFramework_FrameworkUtility {
    public $aDescriptions = array();
    public $sClassAttribute = 'wp-favorite-posts-form-element-description';
