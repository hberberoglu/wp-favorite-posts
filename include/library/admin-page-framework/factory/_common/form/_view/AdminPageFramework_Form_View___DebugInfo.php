...
class WPFavoritePostsAdminPageFramework_Form_View___DebugInfo extends WPFavoritePostsAdminPageFramework_FrameworkUtility {
    ...
    public function get() {
        ...
        return "<div class='wp-favorite-posts-info'>" . $this->oMsg->get('debug_info') . ': ' . $this->getFrameworkNameVersion() . "</div>";
    }
