...
class WPFavoritePostsAdminPageFramework_Form_View___Generate_FieldTagID extends WPFavoritePostsAdminPageFramework_Form_View___Generate_Field_Base {
    public function get() {
...
class WPFavoritePostsAdminPageFramework_Form_View___Generate_FieldInputID extends WPFavoritePostsAdminPageFramework_Form_View___Generate_FieldTagID {
    public $isIndex = '';
