...
class WPFavoritePostsAdminPageFramework_Form_View___Generate_FieldInputName extends WPFavoritePostsAdminPageFramework_Form_View___Generate_FlatFieldName {
    public $sIndex = '';
...
class WPFavoritePostsAdminPageFramework_Form_View___Generate_FlatFieldInputName extends WPFavoritePostsAdminPageFramework_Form_View___Generate_FieldInputName {
    public function get() {
        $_sIndex = $this->getAOrB('0' !== $this->sIndex && empty($this->sIndex), '', "|{$this->sIndex}");
