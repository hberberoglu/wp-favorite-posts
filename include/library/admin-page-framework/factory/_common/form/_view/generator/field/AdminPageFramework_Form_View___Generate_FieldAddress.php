...
abstract class WPFavoritePostsAdminPageFramework_Form_View___Generate_Field_Base extends WPFavoritePostsAdminPageFramework_Form_View___Generate_Section_Base {
...
class WPFavoritePostsAdminPageFramework_Form_View___Generate_FieldName extends WPFavoritePostsAdminPageFramework_Form_View___Generate_Field_Base {
    public function get() {
...
class WPFavoritePostsAdminPageFramework_Form_View___Generate_FlatFieldName extends WPFavoritePostsAdminPageFramework_Form_View___Generate_FieldName {
    public function get() {
...
class WPFavoritePostsAdminPageFramework_Form_View___Generate_FieldAddress extends WPFavoritePostsAdminPageFramework_Form_View___Generate_FlatFieldName {
    public function get() {
