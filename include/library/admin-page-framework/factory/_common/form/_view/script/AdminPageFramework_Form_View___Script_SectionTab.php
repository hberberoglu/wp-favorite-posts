...
class WPFavoritePostsAdminPageFramework_Form_View___Script_SectionTab extends WPFavoritePostsAdminPageFramework_Form_View___Script_Base {
...
jQuery( '.wp-favorite-posts-section-tabs-contents' ).createTabs(); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='wp-favorite-posts-section-tabs-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
}
