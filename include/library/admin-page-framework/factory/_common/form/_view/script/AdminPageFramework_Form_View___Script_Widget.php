...
class WPFavoritePostsAdminPageFramework_Form_View___Script_Widget extends WPFavoritePostsAdminPageFramework_Form_View___Script_Base {
    ...
    $( document ).ready( function() {
        ...
        $( document ).ajaxComplete( function( event, XMLHttpRequest, ajaxOptions ) {
            ...
            if( _aRequest.action && ( 'save-widget' === _aRequest.action ) ) {
                ...
                if ( $( _oWidget ).find( '.wp-favorite-posts-sectionset' ).length <= 0 ) { 
                    return; 
                }   
                ...
                $( document ).trigger( 
                    'wp-favorite-posts_saved_widget', 
                    _oWidget 
                );
