...
class WPFavoritePostsAdminPageFramework_Form_View___Attribute_SectionsTablesContainer extends WPFavoritePostsAdminPageFramework_Form_View___Attribute_Base {
    ...
    protected function _getAttributes() {
        return array('id' => $this->sSectionsID, 'class' => $this->getClassAttribute('wp-favorite-posts-sections', $this->getAOrB(!$this->sSectionTabSlug || '_default' === $this->sSectionTabSlug, null, 'wp-favorite-posts-section-tabs-contents'), $this->getAOrB(empty($this->aCollapsible), null, 'wp-favorite-posts-collapsible-sections-content' . ' ' . 'wp-favorite-posts-collapsible-content' . ' ' . 'accordion-section-content'), $this->getAOrB(empty($this->aSectionset['sortable']), null, 'sortable-section')), 'data-seciton_id' => $this->aSectionset['section_id'], 'data-section_address' => $this->aSectionset['section_id'], 'data-section_address_model' => $this->aSectionset['section_id'] . '|' . '___i___',) + $this->_getDynamicElementArguments($this->aSectionset);
    }
    private function _getDynamicElementArguments($aSectionset) {
        ...
        $_oSectionNameGenerator = new WPFavoritePostsAdminPageFramework_Form_View___Generate_SectionName($aSectionset, $aSectionset['_caller_object']->aCallbacks['hfSectionName']);
