...
JAVASCRIPTS;
    ...
    private function ___getRepeatableButtonHTML($sFieldsContainerID, array $aArguments, $iFieldCount, $bSmall = true) {
        $_oFormatter = new WPFavoritePostsAdminPageFramework_Form_Model___Format_RepeatableField($aArguments, $this->oMsg);
    ...
    private function ___getContainerAttributes($aArguments) {
        $_aContainerAttributes = array('class' => $this->getClassAttribute('wp-favorite-posts-repeatable-field-buttons', !empty($aArguments['disabled']) ? 'disabled' : ''),);
