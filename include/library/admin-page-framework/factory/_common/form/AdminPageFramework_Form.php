...
abstract class WPFavoritePostsAdminPageFramework_Form_Utility extends WPFavoritePostsAdminPageFramework_FrameworkUtility {
    ...
    static public function getFieldsetReformattedBySubFieldIndex(array $aFieldset, $iSubFieldIndex, $bHasSubFields, array $aParentFieldset) {
        ...
        $_oFieldsetFormatter = new WPFavoritePostsAdminPageFramework_Form_Model___Format_Fieldset($aFieldset, $aFieldset['_structure_type'], $aFieldset['capability'], ( integer )$iSubFieldIndex + 1, $aFieldset['_subsection_index'], $aFieldset['_is_section_repeatable'], $aFieldset['_caller_object']);
        $aFieldset = $_oFieldsetFormatter->get();
        $_oFieldsetOutputFormatter = new WPFavoritePostsAdminPageFramework_Form_Model___Format_FieldsetOutput($aFieldset, $aFieldset['_section_index'], $_oCallerForm->aFieldTypeDefinitions);
...
abstract class WPFavoritePostsAdminPageFramework_Form_Base extends WPFavoritePostsAdminPageFramework_Form_Utility {
...
class WPFavoritePostsAdminPageFramework_Form_Model extends WPFavoritePostsAdminPageFramework_Form_Base {
    ...
    public function getSortedInputs(array $aFormInputs) {
        ...
        $_oInputSorter = new WPFavoritePostsAdminPageFramework_Form_Model___Modifier_SortInput($aFormInputs, $_aDynamicFieldAddressKeys);
    ...
    public function dropRepeatableElements(array $aSubject) {
        $_oFilterRepeatableElements = new WPFavoritePostsAdminPageFramework_Form_Model___Modifier_FilterRepeatableElements($aSubject, $this->getElementAsArray($_POST, '__repeatable_elements_' . $this->aArguments['structure_type']));
    ...
    public function _replyToRegisterFormItems() {
        ...
        $_oFieldResources = new WPFavoritePostsAdminPageFramework_Form_Model___SetFieldResources($this->aArguments, $this->aFieldsets, self::$_aResources, $this->aFieldTypeDefinitions, $this->aCallbacks);
    ...
    private function _setSiteWideFieldTypeDefinitions() {
        ...
        $_oBuiltInFieldTypeDefinitions = new WPFavoritePostsAdminPageFramework_Form_Model___BuiltInFieldTypeDefinitions('admin_page_framework', $this->oMsg);
    ...
    public function getDefaultFormValues() {
        $_oDefaultValues = new WPFavoritePostsAdminPageFramework_Form_Model___DefaultValues($this->aFieldsets);
        return $_oDefaultValues->get();
    }
    protected function _formatElementDefinitions(array $aSavedData) {
        $_oSectionsetsFormatter = new WPFavoritePostsAdminPageFramework_Form_Model___FormatSectionsets($this->aSectionsets, $this->aArguments['structure_type'], $this->sCapability, $this->aCallbacks, $this);
        $this->aSectionsets = $_oSectionsetsFormatter->get();
        $_oFieldsetsFormatter = new WPFavoritePostsAdminPageFramework_Form_Model___FormatFieldsets($this->aFieldsets, $this->aSectionsets, $this->aArguments['structure_type'], $this->aSavedData, $this->sCapability, $this->aCallbacks, $this);
...
class WPFavoritePostsAdminPageFramework_Form_View extends WPFavoritePostsAdminPageFramework_Form_Model {
    public function __construct() {
        parent::__construct();
        new WPFavoritePostsAdminPageFramework_Form_View__Resource($this);
    }
    public function get() {
        ...
        new WPFavoritePostsAdminPageFramework_Form_View___Script_Form;
        $_oFormTables = new WPFavoritePostsAdminPageFramework_Form_View___Sectionsets(array('capability' => $this->sCapability,) + $this->aArguments, array('field_type_definitions' => $this->aFieldTypeDefinitions, 'sectionsets' => $this->aSectionsets, 'fieldsets' => $this->aFieldsets,), $this->aSavedData, $this->getFieldErrors(), $this->aCallbacks, $this->oMsg);
    ...
    private function _getNoScriptMessage() {
        ...
        return "<noscript>" . "<div class='error'>" . "<p class='wp-favorite-posts-form-warning'>" . $this->oMsg->get('please_enable_javascript') . "</p>" . "</div>" . "</noscript>";
    }
    public function printSubmitNotices() {
        $this->oSubmitNotice->render();
    }
}
class WPFavoritePostsAdminPageFramework_Form_Controller extends WPFavoritePostsAdminPageFramework_Form_View {
...
class WPFavoritePostsAdminPageFramework_Form extends WPFavoritePostsAdminPageFramework_Form_Controller {
    ...
    public function __construct() {
        ...
        $this->oSubmitNotice = new WPFavoritePostsAdminPageFramework_Form___SubmitNotice;
        $this->oFieldError = new WPFavoritePostsAdminPageFramework_Form___FieldError($this->aArguments['caller_id']);
        $this->oLastInputs = new WPFavoritePostsAdminPageFramework_Form_Model___LastInput($this->aArguments['caller_id']);
        parent::__construct();
        $this->construct();
    }
