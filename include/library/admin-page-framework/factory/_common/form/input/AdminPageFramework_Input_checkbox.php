...
abstract class WPFavoritePostsAdminPageFramework_Input_Base extends WPFavoritePostsAdminPageFramework_FrameworkUtility {
    public $aField = array();
    public $aAttributes = array();
    public $aOptions = array();
    public $aStructureOptions = array('input_container_tag' => 'span', 'input_container_attributes' => array('class' => 'wp-favorite-posts-input-container',), 'label_container_tag' => 'span', 'label_container_attributes' => array('class' => 'wp-favorite-posts-input-label-string',),);
...
class WPFavoritePostsAdminPageFramework_Input_checkbox extends WPFavoritePostsAdminPageFramework_Input_Base {
