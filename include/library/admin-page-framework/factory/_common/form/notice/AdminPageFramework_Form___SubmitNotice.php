...
class WPFavoritePostsAdminPageFramework_Form___SubmitNotice extends WPFavoritePostsAdminPageFramework_FrameworkUtility {
    ...
    public function render() {
        new WPFavoritePostsAdminPageFramework_AdminNotice('');
    ...
    private function _printNotices($aNotices) {
        ...
        foreach (array_filter(( array )$aNotices, 'is_array') as $_aNotice) {
            ...
            new WPFavoritePostsAdminPageFramework_AdminNotice($this->getElement($_aNotice, 'sMessage'), $this->getElement($_aNotice, 'aAttributes'));
        }
    }
}
