...
abstract class WPFavoritePostsAdminPageFramework_Resource_Base extends WPFavoritePostsAdminPageFramework_FrameworkUtility {
    ...
    protected $_sClassSelector_Style = 'wp-favorite-posts-style';
    protected $_sClassSelector_Script = 'wp-favorite-posts-script';
    ...
    private function _getStyleTag($oCaller, $sIDPrefix) {
        $_sStyle = $this->addAndApplyFilters($oCaller, array("style_common_admin_page_framework", "style_common_{$this->oProp->sClassName}",), WPFavoritePostsAdminPageFramework_CSS::getDefaultCSS());
    ...
    private function _getIEStyleTag($oCaller, $sIDPrefix) {
        $_sStyleIE = $this->addAndApplyFilters($oCaller, array("style_ie_common_admin_page_framework", "style_ie_common_{$this->oProp->sClassName}",), WPFavoritePostsAdminPageFramework_CSS::getDefaultCSSIE());
    ...
    protected function _printCommonScripts($sIDPrefix, $sClassName) {
        ...
        $_sScript = $this->addAndApplyFilters($this->oProp->oCaller, array("script_common_admin_page_framework", "script_common_{$this->oProp->sClassName}",), WPFavoritePostsAdminPageFramework_Property_Base::$_sDefaultScript);
    ...
    public function _replyToAddStyle() {
        ...
        $this->_printCommonStyles('wp-favorite-posts-style-common', get_class());
    ...
    public function _replyToAddScript() {
        ...
        $this->_printCommonScripts('wp-favorite-posts-script-common', get_class());
