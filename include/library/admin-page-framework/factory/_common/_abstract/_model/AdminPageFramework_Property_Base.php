...
abstract class WPFavoritePostsAdminPageFramework_Property_Base extends WPFavoritePostsAdminPageFramework_FrameworkUtility {
    ...
    private function ___setProperties($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType) {
        ...
        $this->sTextDomain = empty($sTextDomain) ? 'wp-favorite-posts' : $sTextDomain;
    ...
    private function ___setGlobals() {
        if (!isset($GLOBALS['aWPFavoritePostsAdminPageFramework'])) {
            $GLOBALS['aWPFavoritePostsAdminPageFramework'] = array('aFieldFlags' => array());
        }
    }
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => WPFavoritePostsAdminPageFramework_Registry::NAME, 'sURI' => WPFavoritePostsAdminPageFramework_Registry::URI, 'sScriptName' => WPFavoritePostsAdminPageFramework_Registry::NAME, 'sLibraryName' => WPFavoritePostsAdminPageFramework_Registry::NAME, 'sLibraryURI' => WPFavoritePostsAdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => WPFavoritePostsAdminPageFramework_Registry::getVersion(), 'sDescription' => WPFavoritePostsAdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => WPFavoritePostsAdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => WPFavoritePostsAdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => WPFavoritePostsAdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => WPFavoritePostsAdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
    ...
    public function __get($sName) {
        ...
        if ('oUtil' === $sName) {
            $this->oUtil = new WPFavoritePostsAdminPageFramework_WPUtility;
            return $this->oUtil;
        }
    }
}
