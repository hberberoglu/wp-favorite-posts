...
abstract class WPFavoritePostsAdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected $oHelpPane;
    protected $oLink;
    protected $_aSubClassPrefixes = array('oForm' => 'WPFavoritePostsAdminPageFramework_Form_', 'oPageLoadInfo' => 'WPFavoritePostsAdminPageFramework_PageLoadInfo_', 'oResource' => 'WPFavoritePostsAdminPageFramework_Resource_', 'oHelpPane' => 'WPFavoritePostsAdminPageFramework_HelpPane_', 'oLink' => 'WPFavoritePostsAdminPageFramework_Link_',);
    private $_aSubClassNames = array('oProp' => null, 'oDebug' => 'WPFavoritePostsAdminPageFramework_Debug', 'oUtil' => 'WPFavoritePostsAdminPageFramework_FrameworkUtility', 'oMsg' => 'WPFavoritePostsAdminPageFramework_Message', 'oForm' => null, 'oPageLoadInfo' => null, 'oResource' => null, 'oHelpPane' => null, 'oLink' => null,);
    ...
    private function _triggerUndefinedMethodWarning($sMethodName) {
        trigger_error(WPFavoritePostsAdminPageFramework_Registry::NAME . ': ' . sprintf(__('The method is not defined: %1$s', $this->oProp->sTextDomain), $sMethodName), E_USER_WARNING);
    }
    public function __toString() {
        return WPFavoritePostsAdminPageFramework_FrameworkUtility::getObjectInfo($this);
    }
...
abstract class WPFavoritePostsAdminPageFramework_Factory_Model extends WPFavoritePostsAdminPageFramework_Factory_Router {
    public function __construct($oProp) {
...
abstract class WPFavoritePostsAdminPageFramework_Factory_View extends WPFavoritePostsAdminPageFramework_Factory_Model {
    public function __construct($oProp) {
        parent::__construct($oProp);
        new WPFavoritePostsAdminPageFramework_Factory_View__SettingNotice($this, $this->oProp->sSettingNoticeActionHook);
    }
...
abstract class WPFavoritePostsAdminPageFramework_Factory_Controller extends WPFavoritePostsAdminPageFramework_Factory_View {
...
abstract class WPFavoritePostsAdminPageFramework_Factory extends WPFavoritePostsAdminPageFramework_Factory_Controller {
}
