...
class WPFavoritePostsAdminPageFramework_Property_page_meta_box extends WPFavoritePostsAdminPageFramework_Property_post_meta_box {
    ...
    public function __construct($oCaller, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'wp-favorite-posts', $sStructureType = 'page_meta_box') {
        unset($this->oAdminPage, $this->aHelpTabs);
        parent::__construct($oCaller, $sClassName, $sCapability, $sTextDomain, $sStructureType);
        $GLOBALS['aWPFavoritePostsAdminPageFramework']['aMetaBoxForPagesClasses'] = $this->getElementAsArray($GLOBALS, array('aWPFavoritePostsAdminPageFramework', 'aMetaBoxForPagesClasses'));
        $GLOBALS['aWPFavoritePostsAdminPageFramework']['aMetaBoxForPagesClasses'][$sClassName] = $oCaller;
    }
    ...
    private function _getOwnerObjectOfPage($sPageSlug) {
        $_aPageClasses = $this->getElementAsArray($GLOBALS, array('aWPFavoritePostsAdminPageFramework', 'aPageClasses'));
