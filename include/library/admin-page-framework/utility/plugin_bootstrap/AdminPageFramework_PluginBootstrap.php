...
abstract class WPFavoritePostsAdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('WPFavoritePostsAdminPageFramework_RegisterClasses', false)) {
            return;
        }
        new WPFavoritePostsAdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
